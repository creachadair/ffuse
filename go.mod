...
require (
	...
	github.com/creachadair/ffstools v0.3.1
...
require (
	...
	github.com/creachadair/chirp v0.0.0-20240106233957-cd4864454555 // indirect
	github.com/creachadair/chirpstore v0.0.0-20240106234105-5790f2d22d06 // indirect
